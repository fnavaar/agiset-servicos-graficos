...
- 2026-08-21 · [Francisneverson / SkillMind] · F1-T01 implementada: migration 0001 criou collections `empresas`, `contatos` e `solicitacoes` no PocketBase (Skip Cloud); frontend com formulário de nova solicitação e lista; código imutável `SOL-XXXXXX` gerado no frontend; estados `rascunho`, `aguardando_dados`, `em_excecao_humana` configurados; QA pipeline green (v0.0.2→v0.0.4). Teste humano aguardando: Felippe.
