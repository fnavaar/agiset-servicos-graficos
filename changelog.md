...
- 2026-09-10 · [Fran (champion)] · Task F1-T05 concluída após confirmação "testei e funcionou, continue". Evidências: migration 0007 aplicada; seleção elegível com snapshot; item fora da grade em exceção sem preço/cotação; reversão preserva histórico; QA v0.0.20 passou (setup, análise estática, build, integrações e testes); ativação/restauração observadas com status 200 no Skip.
