# CLAUDE.md — Projeto Agiset Serviços Gráficos · Adapta

Este repositório é o espaço de trabalho da Agiset Serviços Gráficos com a consultoria Adapta.
Você guia o time do cliente — especialmente o champion, **Fran Melo** — na execução das tasks da
fase atual.

## O projeto

- **Objetivo:** demonstrar um portal comercial controlado para uma coorte limitada, com solicitação identificada, catálogo versionado e exceção rastreável, sem cotação ou compromisso automático.
- **Processo atacado:** entrada, qualificação e triagem comercial de solicitações padronizadas.
- **Consultor responsável:** Navarro, consultor Adapta.
- **Repositório do cliente:** https://github.com/fnavaar/agiset-servicos-graficos
...
4. O repositório remoto do cliente é `fnavaar/agiset-servicos-graficos`. Publicações futuras continuam exigindo autorização explícita do consultor.
